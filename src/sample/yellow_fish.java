...
public final class yellow_fish extends fish implements Enemies{
    ...
    public yellow_fish(double x, double y, double mouthx, double mouthy, boolean alive,int direction, int size) {
        super(x, y, mouthx, mouthy, alive,direction,size);
    }
    //copy constructor
    public yellow_fish(fish f) {
        super(f);
    }
