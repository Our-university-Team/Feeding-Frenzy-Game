...
public  final class pink_fish extends fish  implements Enemies{
    ...
    public pink_fish(double x, double y, double mouthx, double mouthy, boolean alive,int direction,int size) {
        super(x, y, mouthx, mouthy, alive,direction,size);
    }
    //copy constructor
    public pink_fish(fish f) {
        super(f);
    }
